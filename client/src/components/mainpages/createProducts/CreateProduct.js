...
function CreateProduct(props) {
    ...
    const handleUpload = async(e) =>{
        ...
        try {
            ...
            formData.append('file', file)
                ...
                setLoading(true)
            const res  = await axios.post('https://ecom-eczsp7504-danishmoin21-gmailcom.vercel.app/api/upload', formData, {
    ...
    const removeImage = async () =>{
        try {
            if(!isAdmin) return alert('This is only Admin access')
            setLoading(true)
            await axios.post('https://ecom-eczsp7504-danishmoin21-gmailcom.vercel.app/api/destroy', {public_id: images.public_id }, {
    ...
    const handleSubmit = async(e) =>{
        ...
        try {
            ...
            if(onEdit){
                await axios.put(`https://ecom-eczsp7504-danishmoin21-gmailcom.vercel.app/api/products/${product._id}`, {...product, images}, {
                    headers: { Authorization: token}
                })

            }else{
                await axios.post('https://ecom-eczsp7504-danishmoin21-gmailcom.vercel.app/api/products', {...product, images}, {
                    headers: { Authorization: token}
                })
            }
            setImages(false)
